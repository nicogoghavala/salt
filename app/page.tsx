...
const PHOTOS: Record<string, string> = {
  ...
  // Block photos
  razzia:         `${CDN}/v1781458224/IMG_0126_mzkudz.jpg`,
  petrin:         `${CDN}/v1781458253/IMG_0127_powxsu.jpg`,
  ferments:       `${CDN}/v1781458275/image_cqnh5m.jpg`,
  pompe:          `${CDN}/v1781458311/image_ahpxhh.jpg`,
  pain_beni:      `${CDN}/v1781458325/IMG_0130_zkekcn.jpg`,
  eau_bouche:     `${CDN}/v1781458347/IMG_0132_hoo3o2.jpg`,
  pizza_bonne:    `${CDN}/v1781458364/IMG_0133_xmmacq.jpg`,
  epicerie:       `${CDN}/v1781458382/image_pkklnm.jpg`,
  vanille_noire:  `${CDN}/v1781458403/IMG_0135_qskd2i.jpg`,
  loulou:         `${CDN}/v1781458415/image_qvbg7z.jpg`,
  noailles:       `${CDN}/v1781459523/IMG_0137_hipddi.jpg`,
  cours_julien:   `${CDN}/v1781459532/IMG_0138_zjohfb.jpg`,
  // New food places
  partenope:      `${CDN}/v1781460437/IMG_0140_n20xcj.jpg`,
  saint_esprit:   `${CDN}/v1781460449/IMG_0141_v4ykfy.jpg`,
  limmat:         `${CDN}/v1781460457/image_rmw78f.jpg`,
  escalie:        `${CDN}/v1781460465/IMG_0143_erbbbw.jpg`,
};
...
const FOOD_TIERS: FoodTier[] = [
  ...
  },
  {
    ...
    places:[
      ...
      { name:"Limmat", type:"Restaurant", tag:"Cours Julien", photo:PHOTOS.limmat, colors:G.food,
        desc:"Lili Gadola left Zurich, worked at L'Épicerie L'Idéal, then found a tiny room on the Cours Julien stairs and named it after the river back home. Fish from Marseille fishermen daily, vegetarian alternative always. The menu is written that morning. Natural wine from €2.50. Lunch Mon–Fri, dinner Thu–Fri.", address:"41 Rue Estelle, 13006 Marseille", hours:"Mon–Fri lunch · Thu–Fri dinner" },
      { name:"Le Saint Esprit", type:"Restaurant", tag:"Le Panier", photo:PHOTOS.saint_esprit, colors:G.food,
        desc:"Louis Rohrer left Ripaille and opened inside Le Panier's oldest bakery with his sister Joséphine. Chilean chef Javier Meneses cooks beside a fridge of fresh fish — crudo de mulet, iodine-forward plates, natural wines that move from silky tannins to cloudy clay. Mon and Fri evenings, Sat and Sun lunch and dinner.", address:"16 Rue du Refuge, 13002 Marseille", hours:"Mon & Fri evenings · Sat–Sun lunch & dinner", phone:"09 61 29 30 43" },
      { name:"Trattoria Partenope", type:"Restaurant · Pizzeria", tag:"Le Panier", photo:PHOTOS.partenope, colors:G.food,
        desc:"Andrea Avolio arrived from Naples seven years ago and turned a Le Panier bar into a Neapolitan institution. Italian songs on the speakers, wood-fired pizza, ingredients imported from Mammafiore, natural wines. The most Neapolitan room in Marseille — which makes sense, given the two cities have been brothers for centuries.", address:"56 Rue de l'Évêché, 13002 Marseille" },
      { name:"L'Escalié", type:"Restaurant · Bar", tag:"Cours Julien", photo:PHOTOS.escalie, colors:G.food,
        desc:"At the top of the Cours Julien stairs, which means the terrace has the best view on the street. French tapas, ceviches, suggestions of the day in meat and fish. In the evening crab ravioli, arancini, girolles tartlets. Sunday brunch. The kind of address where lunch becomes afternoon becomes evening without anyone noticing.", address:"80 Cours Julien, 13006 Marseille", hours:"Tue–Sat lunch & dinner · Sun brunch" },
    ]
  },
  {
    ...
    places:[
      { name:"Razzia", type:"Sandwiches · Coffee", tag:"La Plaine", photo:PHOTOS.razzia, colors:G.food,
      ...
      { name:"Pétrin Couchette", type:"Bakery · Café", tag:"Noailles", photo:PHOTOS.petrin, colors:G.food,
      ...
      { name:"Ferments", type:"Bakery · Coffee", tag:"Vauban", photo:PHOTOS.ferments, colors:G.food,
      ...
      { name:"Pompe", type:"Bakery", tag:"Vauban", photo:PHOTOS.pompe, colors:G.food,
      ...
      { name:"Pain Béni", type:"Sandwiches · Coffee", tag:"Notre-Dame du Mont", photo:PHOTOS.pain_beni, colors:G.food,
      ...
      { name:"L'Eau à la Bouche", type:"Pizzeria", tag:"Malmousque", photo:PHOTOS.eau_bouche, colors:G.food,
      ...
      { name:"Pizzeria La Bonne Mère", type:"Pizzeria", tag:"Notre-Dame de la Garde", photo:PHOTOS.pizza_bonne, colors:G.food,
      ...
      { name:"L'Épicerie L'Idéal", type:"Grocery · Lunch", tag:"Noailles", photo:PHOTOS.epicerie, colors:G.food,
      ...
      { name:"Vanille Noire", type:"Gelato", tag:"Le Panier · Opéra", photo:PHOTOS.vanille_noire, colors:G.food,
      ...
      { name:"Loulou Monsieur Glacé", type:"Gelato · Coffee", tag:"Corniche", photo:PHOTOS.loulou, colors:G.food,
      ...
      { name:"Marché du Cours Julien", type:"Market", tag:"Cours Julien", photo:PHOTOS.cours_julien, colors:G.food,
      ...
      { name:"Noailles Market", type:"Street Market", tag:"Noailles", photo:PHOTOS.noailles, colors:G.food,
